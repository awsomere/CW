...
public class AddAssetStage extends WrapperClass{
  ...
  //-----------------------
    ...
    //Fill data for Media Devices
      assertTextXpath("//div[2]/div/div/div/div[2]/div/label");
      clickByXpath("//div[2]/div/div/div/div[2]/div/label");
      Reporter.log("Backup Media Devices | ");
      Thread.sleep(3000);  
      
      //Fill data for Media Devices
      assertTextXpath("//div[2]/div/div[2]/div/label");
      clickByXpath("//div[2]/div/div[2]/div/label");
      ...
      //Fill data for Media Devices
      assertTextXpath("//div[2]/div[2]/div/div/div/div[2]/div/label");
      clickByXpath("//div[2]/div[2]/div/div/div/div[2]/div/label");
      Reporter.log("Backup Media Devices | ");
      Thread.sleep(3000);  
      ...
      //Fill data for Media Devices
      assertTextXpath("//div[3]/div[2]/div/div/div[2]/div[2]/div/label");
      clickByXpath("//div[3]/div[2]/div/div/div[2]/div[2]/div/label");
      Reporter.log("Backup Media Devices | ");
      Thread.sleep(3000);  
      
      //Fill data for Media Devices
      assertTextXpath("//div[3]/div[2]/div/div[2]/div/div[2]/div/label");
      clickByXpath("//div[3]/div[2]/div/div[2]/div/div[2]/div/label");
      Reporter.log("Backup Media Devices | ");
      Thread.sleep(3000);  
      
      //Fill data for Media Devices
      assertTextXpath("//div[3]/div[2]/div/div[2]/div[2]/div[2]/div/label");
      clickByXpath("//div[3]/div[2]/div/div[2]/div[2]/div[2]/div/label");
      Reporter.log("Backup Media Devices | ");
      Thread.sleep(3000);  
      ...
      //Fill data for Media Devices
      assertTextXpath("//div[4]/div[2]/div/div/div/div[2]/div/label");
      clickByXpath("//div[4]/div[2]/div/div/div/div[2]/div/label");
      Reporter.log("Backup Media Devices | ");
      Thread.sleep(3000);  
...
//click on Done button and save
    ...
    @Test(priority=15, enabled = true)
	  public void Prepoduction_Staus_CreateAsset() throws IOException, InterruptedException {
	      ...
	      ArrowDown();
	          ...
	          //Select Value from Drop-down
	          Thread.sleep(2000);
	          selectByXpath_Visibletext("//*[@id='save_as']", "PreProduction");  
	          Thread.sleep(3000);
 ...
 public void DeleteBtn_AssetInventoryList() throws InterruptedException, IOException
 {
      ...
      assertTextXpath("//*[@id='assets_wrapper']/div[1]/div[1]/div[1]/a[3]");
 ...
 public void Search_AssetInventoryList() throws InterruptedException, IOException
 {
      ...
      sendvaluebyxpath("//label/input", "New");
