...
public class AssetInventoryList extends WrapperClass{
	
	  public WebDriver driver;
	  String browser=null;
	  String Asset_Wizard ="New Asset Wizard in Automation";
	  ...
	  String BussinessOwner = "PHUY@sybrant.com";
	...
	//----------------
	   ...
	   public void ChkBussinessOwnerPopup_AssetWizard_CES() throws IOException, InterruptedException {
		...
		//CLick on Create a New User: Radio Button
		  ...
		  // CLick on Use freeform data: Radio Button
		   ...
		   Thread.sleep(6000);
		   sendvaluebyxpath("html/body/div[6]/div/div/div[2]/div/div/div/div/input", "Automation Bussinees User");
		      Thread.sleep(3000);
	 ...
	 public void BusinessOwnerPopup_AssetWizard_CES() throws IOException, InterruptedException {
	      ...
	      Thread.sleep(5000);          
	      sendvaluebyxpath("html/body/div[6]/div/div/div[2]/div/div/form/div[1]/div/div/div/div[1]/div[1]/div/input", "AFirst User");
	      Thread.sleep(3000);      
	      sendvaluebyxpath("html/body/div[6]/div/div/div[2]/div/div/form/div[1]/div/div/div/div[2]/div[1]/div/input", BussinessOwner);
	      Thread.sleep(3000);
	      sendvaluebyxpath("html/body/div[6]/div/div/div[2]/div/div/form/div[1]/div/div/div/div[1]/div[2]/div/input", "ALast User");
	      Thread.sleep(3000);
	  ...
	  //Click on Physical Location drop-down
	    ...
	    assertTextXpath("//div[6]/div/div/select/option[2]");
	    clickByXpath("//div[6]/div/div/select/option[2]"); 
	    Thread.sleep(8000); 	   
	    
	    //Enter the values in Abbreviation Textbox
	    clickByXpath("//div[6]/div[2]/div/input"); 
	    Thread.sleep(3000);
	    sendvaluebyxpath("//div[6]/div[2]/div/input", "Physical");                   
	    Thread.sleep(8000); 
	    
	  //Enter the values in Location Name Textbox
	    clickByXpath("//div[2]/div[2]/input"); 
	    Thread.sleep(3000);
	    sendvaluebyxpath("//div[2]/div[2]/input", "Automation Location");
	    Thread.sleep(8000);
	    ...
	    clickByXpath("//div[6]/div[2]/div[2]/button"); 
	    Thread.sleep(8000);  
	    Thread.sleep(5000);  
	...
	public void ChkRecentNameLink_ComponentGroupsWizard() throws IOException, InterruptedException {
		  ...
		  public void AllGroups_ComponentGroupsWizard() throws IOException, InterruptedException {
			   ...
			   //Click on Select button 
			     ...
			     //Close the pop-up
			     clickByXpath("//div[3]/div/div[2]/button"); 
			     Thread.sleep(8000); 
			     Thread.sleep(8000); 
	...
	public void ReviewGrouping_ComponentGroupsWizard() throws IOException, InterruptedException {
