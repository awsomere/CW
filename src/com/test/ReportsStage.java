...
public class ReportsStage extends WrapperClass{
	  ...
	  public void RiskRatingReportFilter() throws InterruptedException {
		        ...
		        //Thread.sleep(3000);
		  		...
		  		Thread.sleep(3000);
		  		//Thread.sleep(3000);
		  		assertTextXpath("//div[2]/div[3]/div/div/div/ul/li");
		  		clickByXpath("//div[2]/div[3]/div/div/div/ul/li");
		  		Reporter.log("Select value from Asset Drop-down | ");
		  		Thread.sleep(3000);
		  		//Thread.sleep(3000);		 
		  		
		     	//Click on Sensitive Data Type drop-down
