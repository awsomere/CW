...
//		}
	...
	public void EnabledTextByXpath(String xpath) {
		
		 WebElement element1 = driver.findElement(By.xpath(xpath));
		 Assert.assertTrue(element1.isEnabled());
	}
	 
	 public void NotEnabledTextByXpath(String xpath) {
	 ...
	 public void IsDisplayedTextByXpath(String xpath) {
	 ...
	 public void NotDisplayedTextByXpath(String xpath) {
...
//		   System.out.println("The Search element "+xpath+" is not found");
   ...
   public void mouseHoverdownByXpath(String xpath) {
	...
	public void doubleclickbyXpath(String xpath) {
	   ...
	   public void doubleclickbycssSelector(String selector) {
			try {
	   ...
	   public void GetText(String xpath){
		    ...
		    WebElement element = driver.findElement(By.xpath(xpath));
		    Expvalue = element.getText();   
		    Reporter.log(Expvalue);
...
//	  }
 ...
 public void CompareTextValue(String gettext,String GetText){
	   try {
  Assert.assertEquals(actvalue,Expvalue);
  //Reporter.log("Parent entity details get Cascaded in Child entity | ");
  Reporter.log("Same Cascade statistics. Cascaded Successfully");
		} catch (Exception e) {
			Reporter.log("Not Same Cascade statistics.. Cascading Failed");
			
		  }
		
	}

public void NotEqualCompareTextValue(String gettext,String GetText){
	   try {
  Assert.assertNotEquals(actvalue,Expvalue);
  //Reporter.log("Parent entity details get Cascaded in Child entity | ");
  Reporter.log("Response are not Same. Cascaded Successfully");
		} catch (Exception e) {
			Reporter.log("Same Response. Cascading Failed");
...
//		   }
	    ...
	    public void ArrowUp() {
		 	   try {
		 	    Actions mouseAction = new Actions(driver);
		 	    Actions seriesOfActions = mouseAction.sendKeys(Keys.ARROW_UP);
		 	    seriesOfActions.build().perform();
...
//		     }
	...
	public void sortdesc(String xpath) {
		...
		//create an List Array and store the products (web elements) into the linkedlist
	    ...
	    for(int i =0;i<listElement.size();i++) {
	    	...
	    	//System.out.println("Before Sorting, Textvalues of Column header are \t" + elementText); 
